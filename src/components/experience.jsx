...
export function Experience() {
  ...
  const experiences = [
    {
      place: 'Lazarillo', role: "Full Stack Developer", date: 'December 2021 - Present', tasks:
    ...
    {
      place: 'ExmerDev', role: "Backend Developer", date: 'Feb 2021 - Mar 2021', tasks:
    ...
    {
      place: 'Laboratorio de Innovación e Investigación Docente', role: "Full Stack Developer", date: 'Apr 2021 - Ago 2021', tasks:
    ...
    {
      place: 'Laboratorio de Innovación e Investigación Docente', role: "Backend Department Leader", date: 'Apr2020 -Feb 2021', tasks:
        ["Lead backend team and deployment of web platforms in areas of: health, education",
        ]
    },
    {
      place: 'Laboratorio de Innovación e Investigación Docente', role: "Backend Developer", date: 'Oct 2019 - Feb 202', tasks:
  ...
  const customizedMarker = () => {
    return (
      <span style={{ backgroundColor: "#607D8B", borderRadius: "50%", padding: "0.5em" }}>
